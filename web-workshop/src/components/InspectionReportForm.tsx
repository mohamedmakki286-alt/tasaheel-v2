              ...
              {parts.map((part, index) => (
                <div key={index} className="flex items-center gap-2 p-3 rounded-xl bg-surface-50 border border-surface-200 animate-slide-up">
                  ...
                  <input
                    ...
                    placeholder={t('components.inspectionReportForm.price')}
                    min="0"
                    step="0.01"
                  />
              ...
              {labor.map((item, index) => (
                <div key={index} className="flex items-center gap-2 p-3 rounded-xl bg-surface-50 border border-surface-200 animate-slide-up">
                  ...
                  <input
                    ...
                    className="input-field w-16 text-sm py-2 text-center"
                    placeholder={t('components.inspectionReportForm.hours')}
                    min="0.5"
                    step="0.5"
                  />
                  <input
                    ...
                    className="input-field w-24 text-sm py-2"
                    placeholder={t('components.inspectionReportForm.hourly')}
                    min="0"
                    step="0.01"
                  />
