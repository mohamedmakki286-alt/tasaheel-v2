  ...
  return (
    <>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,rgba(245,158,11,0.03),transparent_70%)]" />

        {/* Glowing orbs */}
        <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-accent-500/5 blur-3xl animate-pulse-glow" />
        ...
        <div className="absolute top-1/3 left-1/4 w-64 h-64 rounded-full bg-primary-500/5 blur-3xl animate-pulse-glow" style={{ animationDelay: '4s' }} />
        ...
        {/* Geometric shapes */}
        <div className="absolute top-[15%] right-[10%] w-2 h-2 rounded-full bg-accent-500/20 animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-[40%] right-[60%] w-3 h-3 rounded-full bg-accent-500/15 animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute top-[70%] right-[30%] w-1.5 h-1.5 rounded-full bg-accent-500/25 animate-pulse" style={{ animationDelay: '3s' }} />
        <div className="absolute top-[25%] right-[80%] w-2.5 h-2.5 rounded bg-accent-500/10 rotate-45 animate-pulse" style={{ animationDelay: '1.5s' }} />
        <div className="absolute top-[80%] right-[70%] w-2 h-2 rounded bg-accent-500/10 rotate-45 animate-pulse" style={{ animationDelay: '2.5s' }} />
