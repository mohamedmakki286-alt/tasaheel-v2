...
export default function OAuthButtons() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 py-3 rounded-2xl border border-surface-700 bg-surface-800/50 hover:bg-surface-700/50 text-surface-200 hover:text-white transition-all duration-200"
    >
