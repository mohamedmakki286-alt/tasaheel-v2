...
public class InspectionReportService {
    ...
    public InspectionReportDTO createReport(Long requestId, Long workshopId,
        ...
        if (!request.getStatus().equals("accepted") && !request.getStatus().equals("customer_approved") && !request.getStatus().equals("in_progress")) {
            throw new BadRequestException("Request must be in accepted/customer_approved/in_progress status to create inspection report");
        }
