...
export default function ChatPage() {
  ...
  const comingSoon = (feature: string) => toast(`${feature} ستتوفر عند ربط الاتصال والوسائط الحية.`);
